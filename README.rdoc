...
Concept - 
Run an rails app to fetch cargo flight only data from a 3rd party to enable Users(exporters/airfreight agents) to request quotation and make a booking for oversize cargo along with tracking of booked shipments.
