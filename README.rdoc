– Air freighter App.- 
Rails REST API fetching flight XML data with API integration from a 3rd party.
(https://uk.flightaware.com/commercial/data/)

Concept - 
Run an rails app to fetch cargo flight only data from a 3rd party to enable Users(exporters/airfreight agents) to request
a quotation and make a booking for oversize cargo along with tracking of booked shipments.

This app was developed in AWS C9 enviroment with flight XML data API integration from a 3rd party.
(https://uk.flightaware.com/commercial/data/)
...
‘$ sudo service postgresql start’ prior to starting the rails server - 
